...
public class Device extends Owner{
	public static final String type = INodeType.DEVICE;
	public static final String initialName = INodeInitialName.DEVICE;
	
	private Rectangle constraint;
	
	public static final String P_CONSTRAINT = "_constraint_device";
	public static final String P_TEXT = "_textDevice";
	
	public static final String P_CHILDREN = "_children_device";
	
	public static final String P_SOURCE_LOCATEIN_CONNECTION = "_source_locateIn_connection_device";
	public static final String P_TARGET_LOCATEIN_CONNECTION = "_target_locateIn_connection_device";
	
	public static final String P_TARGET_BELONGTO_CONNECTION = "_target_belongTo_connection_device";
	...
	public void addSourceConnection(Object connx){
		if(connx instanceof LocateInConnection){
			...
			this.firePropertyChange(Device.P_SOURCE_LOCATEIN_CONNECTION, null, null);	
		}
	}
