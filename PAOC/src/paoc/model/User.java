...
public class User extends Owner{
	public static final String type = INodeType.USER;
	public static final String initialName = INodeInitialName.USER;
	
	public static final String P_CHILDREN = "_children_user";
	
	private Rectangle constraint;
	
	public static final String P_CONSTRAINT = "_constraint_user";
	public static final String P_TEXT = "_textUSer";
	...
	public void addSourceConnection(Object connx){
		if(connx instanceof LocateInConnection){
			...
			this.firePropertyChange(P_SOURCE_LOCATEIN_CONNECTION, null, null);
		}
	}
