...
public class BelongToConnectionEditPart extends AbstractConnectionEditPart implements PropertyChangeListener{

	protected IFigure createFigure(){
		PolylineConnection connection = (PolylineConnection)super.createFigure();
		connection.setConnectionRouter(new BendpointConnectionRouter());
		
		final Label label = new Label(IConnectionLabel.BELONGSTO);
	...
	public void activate(){
		super.activate();
		((BelongToConnection)this.getModel()).addPropertyChangeListener(this);
	}
	
	public void deactivate(){
		((BelongToConnection)this.getModel()).removePropertyChangeListener(this);
		super.deactivate();
	}
	
	protected void refreshBendpoints(){
		List<Point> bendpoints = ((BelongToConnection)this.getModel()).getBendpoints();
	...
	public void propertyChange(PropertyChangeEvent event) {
		// TODO Auto-generated method stub
		if(event.getPropertyName().equals(BelongToConnection.P_BEND_POINT))
			refreshBendpoints();
	}
