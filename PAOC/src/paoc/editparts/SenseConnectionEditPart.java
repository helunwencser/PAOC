...
public class SenseConnectionEditPart extends AbstractConnectionEditPart implements PropertyChangeListener{

	protected IFigure createFigure(){
		PolylineConnection connection = (PolylineConnection)super.createFigure();
		connection.setConnectionRouter(new BendpointConnectionRouter());
		
		final Label label = new Label(IConnectionLabel.SENSE);
	...
	public void activate(){
		super.activate();
		((SenseConnection)this.getModel()).addPropertyChangeListener(this);
	}
	
	public void deactivate(){
		((SenseConnection)this.getModel()).removePropertyChangeListener(this);
		super.deactivate();
	}
	
	protected void refreshBendpoints(){
		List<Point> bendpoints = ((SenseConnection)this.getModel()).getBendpoints();
	...
	public void propertyChange(PropertyChangeEvent event) {
		// TODO Auto-generated method stub
		if(event.getPropertyName().equals(SenseConnection.P_BEND_POINT))
			refreshBendpoints();
	}
